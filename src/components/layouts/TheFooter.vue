...
<script>
    ...
    export default {
            ...
            return {
                ...
                contacts: [
                    ...
                    },
                    {
                        icon: 'weixin',
                        title: '加我微信',
                        link: 'http://1.14.200.8/uploads/images/card.jpg'
                    }
                ],
                contactStyle: {
                    paddingRight: '8px'
        ...
        <span style="font-size:0.9em">Designed by
          ...
          <a href="http://1.14.200.8/uploads/images/card.jpg"target="_blank"style="color:inherit">jingkun</a>
        </span>`,
                sponsor: {
                    title: '赞助商',
                    list: [
                ...
                recordNumber: `
                     ...
                     ICP备案：<a href="https://beian.miit.gov.cn">粤ICP备2022130848号</a>
                <span>`
            }
        },
        created() {
            total().then((response) => {
                this.statistics.list = response.data
            })
        }
    }
</script>
